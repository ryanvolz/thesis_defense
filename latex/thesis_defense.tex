...
\begin{frame}{Ionospheric environment: meteoroids and meteors}
 \begin{columns}
  ...
  \end{definition}
  \raggedleft
  \movie[autostart,loop,poster,width=2.1in,height=1.4in]{}{meteor_spectacular_double_shot.mp4}\\
  {\tiny NASA (2011)}
 \end{columns}
\end{frame}
...
\begin{frame}{First-order step}{Smooth}
 ...
 \begin{center}
  \movie[autostart,loop,poster,width=4in,height=2in]{}{gradient_descent_animation.mp4}
 \end{center}
\end{frame}
...
\begin{frame}{Movie of meteor sidelobe removal}
 \movie[autostart,loop,poster,width=4.320687in,height=2.28in]{\includegraphics[width=\textwidth]{head_and_flare_mf_vs_recovered_1}}{head_and_flare_mf_vs_recovered_1.mp4}
\end{frame}
