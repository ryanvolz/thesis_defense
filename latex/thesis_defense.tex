...
\begin{frame}{Delay-frequency sidelobes}
 ...
 \begin{tikzpicture}
  ...
  \node<1>[right] at (0,0) {\includegraphics{head_and_flare_mf_rti_2}};
  \node<2>[left,align=center] at (0,0.5) {Near-ideal\\decoding};
  \node<2>[right] at (0,0) {\includegraphics{head_and_flare_recovered_rti_noise_1}};
  \fill[white] (0,-1.125) rectangle (9,-0.875);
  \node[left,align=center] at (0,-2.3) {Minimum\\sidelobe\\code};
  \node[right] at (0,-2.8) {\includegraphics{head_and_flare_mf_rti_1}};
 \end{tikzpicture}
\end{frame}
...
\begin{frame}{The matched filter}
 ...
 \begin{example}[Barker-13 code]
  \includegraphics[width=0.45\textwidth]{barker13pulse} $\star$ \includegraphics[width=0.45\textwidth]{barker13pulse} $=$\\
  \centering\includegraphics[width=0.45\textwidth]{b13acorr_analog}
 \end{example}
\end{frame}
...
\begin{frame}{Iterative Soft Thresholding}
 \begin{columns}
  ...
  \column{0.4\textwidth}
  \centering
  \includegraphics{ist/ist_x001}
 \end{columns}
 \begin{columns}
  \column{0.3\textwidth}
  Forward model, calculate error:
  \column{0.3\textwidth}
  $z = y - A(h)$
  \column{0.4\textwidth}
  \centering
  \includegraphics{ist/ist_z001}
 \end{columns}
 \begin{columns}
  \column{0.3\textwidth}
  Matched filtering of error:
  \column{0.3\textwidth}
  $A^*(z)$
  \column{0.4\textwidth}
  \centering
  \includegraphics{ist/ist_Asz001}
 \end{columns}
 \begin{columns}
  \column{0.3\textwidth}
  Add previous guess:
  ...
  \column{0.4\textwidth}
  \centering
  \includegraphics{ist/ist_xpt001}
 \end{columns}
 \begin{columns}
  \column{0.3\textwidth}
  Threshold to form new guess:
  \column{0.3\textwidth}
  $h = \mathbf{soft}(h + A^*(z))$
  \column{0.4\textwidth}
  \centering
  \includegraphics{ist/ist_x002}
 \end{columns}
\end{frame}
...
\begin{frame}{Movie of meteor sidelobe removal}
 \centering
 \includegraphics[width=\textwidth]{movie_poster}
 
 \movie[externalviewer]{{\color{red}Click to play}}{head_and_flare_mf_vs_recovered_1.mp4}
%  \includemovie[poster]{}{}{head_and_flare_mf_vs_recovered_1.mp4}
\end{frame}

\begin{frame}{Example: Minimum sidelobe code}
 \begin{tikzpicture}
  \node[left,align=center] at (0,0.5) {Matched\\Filter};
  \node[right] at (0,0) {\includegraphics{head_and_flare_mf_rti_1}};
  \fill[white] (0,-1.125) rectangle (9,-0.875);
  \node[left,align=center] at (0,-2.3) {Waveform\\Inversion};
  \node[right] at (0,-2.8) {\includegraphics{head_and_flare_recovered_rti_noise_1}};
 \end{tikzpicture}
\end{frame}

\begin{frame}{Example: Barker-13 code}
 \begin{tikzpicture}
  \node[left,align=center] at (0,0.5) {Matched\\Filter};
  \node[right] at (0,0) {\includegraphics{head_and_flare_mf_rti_0}};
  \fill[white] (0,-1.125) rectangle (9,-0.875);
  \node[left,align=center] at (0,-2.3) {Waveform\\Inversion};
  \node[right] at (0,-2.8) {\includegraphics{head_and_flare_recovered_rti_noise_0}};
 \end{tikzpicture}
\end{frame}

\begin{frame}{Example: Pseudorandom code}
 \begin{tikzpicture}
  \node[left,align=center] at (0,0.5) {Matched\\Filter};
  \node[right] at (0,0) {\includegraphics{head_and_flare_mf_rti_4}};
  \fill[white] (0,-1.125) rectangle (9,-0.875);
  \node[left,align=center] at (0,-2.3) {Waveform\\Inversion};
  \node[right] at (0,-2.8) {\includegraphics{head_and_flare_recovered_rti_noise_4}};
 \end{tikzpicture}
 \vspace{-6ex}
 \begin{alertblock}{}<2>
...
\begin{frame}{Example: LFM chirp}
 \begin{tikzpicture}
  \node[left,align=center] at (0,0.5) {Matched\\Filter};
  \node[right] at (0,0) {\includegraphics{head_and_flare_mf_rti_3}};
  \fill[white] (0,-1.125) rectangle (9,-0.875);
  \node[left,align=center] at (0,-2.3) {Waveform\\Inversion};
  \node[right] at (0,-2.8) {\includegraphics{head_and_flare_recovered_rti_noise_3}};
 \end{tikzpicture}
 \vspace{-6ex}
 \begin{alertblock}{}<2>
...
\begin{frame}{Example: Uncoded}
 \begin{tikzpicture}
  \node[left,align=center] at (0,0.5) {Matched\\Filter};
  \node[right] at (0,0) {\includegraphics{head_and_flare_mf_rti_2}};
  \fill[white] (0,-1.125) rectangle (9,-0.875);
  \node[left,align=center] at (0,-2.3) {Waveform\\Inversion};
  \node[right] at (0,-2.8) {\includegraphics{head_and_flare_recovered_rti_noise_2}};
 \end{tikzpicture}
 \vspace{-6ex}
 \begin{alertblock}{}<2>
...
\begin{frame}{Waveform inversion code comparison}
 \begin{tikzpicture}
  \node<1>[left,align=center] at (0,0.5) {Minimum\\sidelobe};
  \node<1>[right] at (0,0) {\includegraphics{head_and_flare_recovered_rti_noise_1}};
  \node<2->[left,align=center] at (0,0.5) {Pseudo-\\random};
  \node<2->[right] at (0,0) {\includegraphics{head_and_flare_recovered_rti_noise_4}};
  \fill[white] (0,-1.125) rectangle (9,-0.875);
